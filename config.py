...
def load_args(default_config=None):
  ...
  parser.add_argument('--data_path', type=str, default='media/lipspeak', help='Path to the videos')
  parser.add_argument('--data_list', type=str, default='media/lipspeak/test_list.txt', help='List of (video_path, transcription) entries. Video paths should be relative to --data_path')
  ...
  parser.add_argument('--time_dim', type=int, default=200, help='Max input sequence length in video fram\
es')
  parser.add_argument('--maxlen', type=int, default=200, help='Max output sequence length')

  parser.add_argument('--transcribe_digits', type=bool, default=False, help='Set to replace digits with their transcription')

  # Model
  parser.add_argument('--lip_model_path', type=str, default='models/lrs2_lip_model', help='Path to the trained model to evaluate')
  ...
  parser.add_argument('--feat_output_dir', type=str, default='data/lipspeak', help='Path to save to extracted features')
  parser.add_argument('--dict_file', type=str, default='data/vocab/lipspeak/testdict.dict', help='Path to dicitonary file used')
  parser.add_argument('--query_type', type=str, default='phrase', help='type of query to perform, can be either "phrase" or "word"')
