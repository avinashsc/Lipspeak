...
class ConfigParser:
    def __init__(self, args, options='', timestamp=True, slave_mode=False):
        ...
        self.cfg_fname = Path("./configs/demo/eval.json")
        ...
        self._save_dir = save_dir / 'models' / exper_name / experiment_name / timestamp
        self._log_dir = save_dir / 'log' / exper_name / experiment_name / timestamp
        self._web_log_dir = save_dir / 'web' / exper_name / experiment_name / timestamp
